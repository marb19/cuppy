...
(function() {
    ...
    .factory('editorTabsetService', function(copy) {
        var EditorTabsetService = function() {
            ...
            //                'web/features/cmssmarteditContainer/editorTabset/tabs/visibility/visibilityTabTemplate.html');//commented for 6.0
        };
     ...
     * each of the tabs, which are represented internally as {@link editorTabsetModule.directive:editorTabContent editorTabContent}
     * directives.
     *
