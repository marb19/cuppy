...
module.exports = function(config) {
    config.set({
        ...
        files: [
            ...
            //,
            'buildArtifacts/seLibraries/smartEditContainer/services/functions.js', //only reference function.js, all other dependencies for unit tests must be mocked
            ...
            'web/features/cmssmarteditContainer/**/*.module.js',
