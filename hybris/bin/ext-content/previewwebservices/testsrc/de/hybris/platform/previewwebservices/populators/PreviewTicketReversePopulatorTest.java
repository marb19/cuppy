...
public class PreviewTicketReversePopulatorTest extends ServicelayerTransactionalTest
{
	...
	public void shouldHaveOnlineProductAndStagedContentCatalogs()
	{
		...
		Assert.assertTrue(target.getCatalogVersions().contains(
				catalogVersionService.getCatalogVersion("testContentCatalog", "Staged")));
		Assert.assertTrue(target.getCatalogVersions().contains(
				catalogVersionService.getCatalogVersion("testProductCatalog", "Online")));
