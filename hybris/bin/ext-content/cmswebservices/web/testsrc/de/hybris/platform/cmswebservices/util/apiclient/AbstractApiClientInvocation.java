...
public abstract class AbstractApiClientInvocation implements ApiClientInvocation
{
	...
	private Locale[] hybrisLanguages;
	...
	public Locale[] getHybrisLanguages()
	{
		return hybrisLanguages;
	}

	public void setHybrisLanguages(final Locale[] hybrisLanguages)
	{
		this.hybrisLanguages = hybrisLanguages;
	}
