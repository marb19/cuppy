...
public class PageContentSlotComponentControllerAddAndRemoveWebServiceTest extends ApiBaseIntegrationTest
{
	...
	private static final String CONTENTSLOT_ENDPOINT = "/v1/catalogs/{catalogId}/versions/{versionId}/pagescontentslotscomponents";
	...
	public void shouldAddComponentToSlot_FirstPosition() throws Exception
	{
		...
		final Response<Void> response = apiClient.request()
				.endpoint(replaceUriVariablesWithDefaultCatalogAndCatalogVersion(CONTENTSLOT_ENDPOINT, Maps.newHashMap()))
				.acceptJson()
