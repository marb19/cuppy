...
public class CatalogVersionModelMother extends AbstractModelMother<CatalogVersionModel>
{
	...
	private CatalogVersionModel createCatalogVersionModelByIdAndVersion(final String catalogId, final CatalogVersion version)
	{
		return getFromCollectionOrSaveAndReturn(
				...
				() -> getCatalogVersionDao().findCatalogVersions(catalogId, version.getVersion()),
	...
	{
		return getFromCollectionOrSaveAndReturn(
				() -> getCatalogVersionDao().findCatalogVersions(ID_APPLE.name(), ONLINE.getVersion()),
				() -> CatalogVersionModelBuilder.fromModel(defaultCatalogVersion(true))
						.withCatalog(catalogModelMother.createAppleContentCatalogModel()).withVersion(ONLINE.getVersion()).build());
	}
	...
	public CatalogVersionModel createAppleCatalogVersionModel(final String version)
	{
		...
		CatalogVersionModel catalogVersionSaved = getFromCollectionOrSaveAndReturn(
