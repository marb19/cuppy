...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            styling: {
                src: ['web/webroot/static-resources/dist/smartedit/css/*.css'],
                dest: 'web/webroot/static-resources/dist/smartedit/css/style.css',
            },
            productize: {
                src: [
    ...
    grunt.registerTask('styling_only', ['less', 'concat:styling']);
