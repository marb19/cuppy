...
describe('test GenericEditor class', function() {
    ...
    var editorMediaService, editorLanguageService, responseHandler, fetchMediaDataHandler, fetchEnumDataHandler, systemEventServ;
    var escapeHtml;
    ...
    it('successful init will assign editing structure from API, fetch stoefront languages and process it and call load ', function() {
    ...
    it('removeSelection will remove the added media', function() {
        ...
        editor.removeSelection(selectedElement, 'event');

        expect(selectedElement.selected).toBe(undefined);

    });

    it('tinymceOptions will set elements not to wrap content in a block', function() {
        ...
        expect(editor.tinymceOptions).toEqualData({
    ...
    it('getRestServiceByType returns editorCRUDService for types different from Media and Language', function() {
        ...
        var restService = editor.getRestServiceByType('SomeType');

        expect(restService).toBe(editorCRUDService);
