    ...
    .run(
        function($httpBackend, languageService, I18N_RESOURCE_URI) {
            ...
            var map = [{
                ...
                "id": "3",
                "value": "{\"smartEditLocation\":\"/smarteditcontainerJSTests/e2e/decorator/innerMocksforDecorator.js\"}",
                "key": "applications.BackendMockModule"
            }, {
                "id": "7",
                "value": "{\"smartEditLocation\":\"/smarteditcontainerJSTests/e2e/decorator/dummyCmsDecorators.js\"}",
