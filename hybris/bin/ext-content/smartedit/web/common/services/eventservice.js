 ...
 *
 */
.factory('EventService', function(customTimeout, $q, $log, hitch, EVENT_SERVICE_MODE_ASYNCH, EVENT_SERVICE_MODE_SYNCH) {
    var EventService = function(defaultMode) {
        ...
        this._recursiveCallToEventHandlers = function(eventId, data, index) {
            ...
            return this.eventHandlers[eventId][index](eventId, data).then(hitch(this, function(resolvedDataOfLastSubscriber) {
