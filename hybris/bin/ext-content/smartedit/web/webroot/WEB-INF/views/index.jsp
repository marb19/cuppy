...
<head>
    ...
    <script src="static-resources/thirdparties/tinymce-dist/tinymce.min.js"></script>
    ...
    <script src="static-resources/thirdparties/angular-ui-tinymce/src/tinymce.js"></script>
    <script src="static-resources/thirdparties/angular-mocks/angular-mocks.js"></script>
    <script src="static-resources/thirdparties/moment/min/moment.min.js"></script>
    ...
    <!-- 3rd party css -->
    <link rel="stylesheet" href="static-resources/thirdparties/bootstrap/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="static-resources/techne/css/techne.min.css">
    <link rel="stylesheet" href="static-resources/dist/smartedit/css/style.css">
