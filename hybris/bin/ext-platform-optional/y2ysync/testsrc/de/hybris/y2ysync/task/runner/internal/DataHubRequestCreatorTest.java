...
public class DataHubRequestCreatorTest
{
	...
	public void shouldSuccessfullySendSyncMediaUrlsGrouppedByImpExHeaderAsJSON() throws Exception
	{
		...
		// when
		requestCreator.sendRequest(SYNC_EXECUTION_ID, "/datahub-webapp/v1/data-feeds/y2ysync", new Y2YSyncContext(FEED_NAME, POOL_NAME, TARGET_SYSTEMS));
	...
	private String getExpectedJson()
	{
		return "{\"syncExecutionId\":\"" + SYNC_EXECUTION_ID + "\",\"sourcePlatformUrl\":\"" + HOME_URL + CONSUME_CHANGES_WEBROOT
				...
				+ HOME_URL + "/medias/m4\",\"" + HOME_URL + "/medias/m5\"]}]" + ",\"pool\":\"" + POOL_NAME + "\",\"feed\":\"" + FEED_NAME + "\",\"autoPublishTargetSystems\":\"" + TARGET_SYSTEMS + "\"}";
	}
