...
package de.hybris.platform.oauthauthorizationserver.test.groovy.spock

import de.hybris.platform.oauthauthorizationserver.test.groovy.config.TestConfigFactory
...
abstract class AbstractSpockTest extends Specification {
	...
	private static String LOG4J_PROPERTIES_CLASS_PATH="oauthauthorizationserver/log4j.properties";
	...
	protected static ConfigObject config = TestConfigFactory.createConfig("/groovytests-property-file.groovy");
	...
	protected static final String getCustomerUserName() {
		return config.CUSTOMER_USERNAME
	}

	protected static final String getCustomerPassword() {
		return config.CUSTOMER_PASSWORD
	}

	protected static final String getCustomerManagerUserName() {
		return config.CUSTOMER_MANAGER_USERNAME
	}

	protected static final String getCustomerManagerPassword() {
		return config.CUSTOMER_MANAGER_PASSWORD
	}
