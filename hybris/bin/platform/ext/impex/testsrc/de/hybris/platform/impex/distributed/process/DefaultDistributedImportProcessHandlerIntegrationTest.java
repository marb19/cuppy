...
public class DefaultDistributedImportProcessHandlerIntegrationTest extends ServicelayerBaseTest
{
	...
	@Test
	public void shouldThrowExceptionOnWrongInputDataWithImportStrictMode() throws InterruptedException
	{
		// given
		final String input = "INSERT_UPDATE Title;code[unique=true]\n" //
				+ ";ALABAMA1\n;ALABAMA2\n" //
				...
				+ ";KENTUCKY2;Kentucky2\n";
		final ImportProcessCreationData.ImportProcessContext ctx = new ImportProcessCreationData.ImportProcessContext();
		ctx.setValidationMode(ImpExConstants.Enumerations.ImpExValidationModeEnum.IMPORT_STRICT);
        final ImportProcessCreationData data = new ImportProcessCreationData("TEST_PROCESS", getAsStream(input), importDataDumpStrategy, ctx);
