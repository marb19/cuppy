...
public class DefaultImportDataDumpStrategyTest
{
	...
	public void setUp() throws Exception
	{
		...
		importData1 = new BatchData.ImportData(batchData1, valueLine1, Collections.emptySortedMap(), Collections.emptyMap());
		importData2 = new BatchData.ImportData(batchData2, valueLine2, Collections.emptySortedMap(), Collections.emptyMap());
		importData3 = new BatchData.ImportData(batchData3, valueLine3, Collections.emptySortedMap(), Collections.emptyMap());
	}
