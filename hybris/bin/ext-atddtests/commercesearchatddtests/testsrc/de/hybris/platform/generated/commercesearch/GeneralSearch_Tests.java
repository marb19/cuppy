	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20160315140037_commercesearch_artifact_develop/prepare/build/source/commercesearchatddtests/genresources/robottests/GeneralSearch_Tests.txt"));
		}
