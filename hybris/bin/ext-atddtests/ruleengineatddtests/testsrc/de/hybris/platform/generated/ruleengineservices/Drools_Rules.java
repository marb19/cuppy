	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20160308152335_ruleengine_artifact_release_6_0_0_13ff1fc01b0df4d44707ab0b062e0cd8d589b08f/prepare/build/source/ruleengineatddtests/genresources/robottests/Drools_Rules.txt"));
		}
