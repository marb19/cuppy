	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20160308153721_promotionengine_artifact_release_6_0_0_a172988cba729cabd2e2f2e5cd6d8da2d2a456f2/prepare/build/source/promotionengineatddtests/genresources/robottests/Basic_Promotion_Rules.txt"));
		}
