	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/srv/jenkins/workspace/customerticketingsystem-module_release-6.0.0.0/source/customerticketingc4cintegrationatddtests/genresources/robottests/Get_Ticket.txt"));
		}
