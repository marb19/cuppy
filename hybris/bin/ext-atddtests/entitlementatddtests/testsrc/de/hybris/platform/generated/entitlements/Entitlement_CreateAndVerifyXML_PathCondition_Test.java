	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bamboo-agent/xml-data/build-dir/HYM-ENT24-JOB1/source/entitlementatddtests/genresources/robottests/Entitlement_CreateAndVerifyXML_PathCondition_Test.txt"));
		}
