...
public class AccountSummaryInfoPopulator implements Populator<B2BUnitModel, AccountSummaryInfoData>
{
	...
	private void setAccountManagerDetails(final B2BUnitModel b2bUnitModel, final AccountSummaryInfoData target)
	{
	...
	private String getFormattedCreditLimit(final B2BCreditLimitModel creditLimit)
	{
	...
	private AddressData getDefaultAddress(final B2BUnitData b2bUnitData)
	{
