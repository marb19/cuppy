...
<%@ taglib prefix="multiCheckout" tagdir="/WEB-INF/tags/addons/chineseprofileaddon/responsive/checkout/multi"%>
						...
						<div class="checkout-paymentmethod">
							...
							<form:form method="post" action="${choosePaymentMethodUrl}" class="create_update_payment_form">
								<ul class="delivery_method-list">
									<c:forEach items="${paymentMethodsList}" var="paymentMethod" varStatus="index">
										<li style="list-style-type:none;">
											<label>
												<input type="radio" name="paymentId" value="${paymentMethod.code}" ${(index.index==0 && empty cartData.chinesePaymentInfo.paymentProvider) ? "checked=checked":""} ${cartData.chinesePaymentInfo.paymentProvider eq paymentMethod.code ? "checked=checked":""}/> 
								...
								<ycommerce:testId code="editPaymentMethod_savePaymentMethod_button">
									<button class="btn btn-primary btn-block submit_silentOrderPostForm checkout-next">
