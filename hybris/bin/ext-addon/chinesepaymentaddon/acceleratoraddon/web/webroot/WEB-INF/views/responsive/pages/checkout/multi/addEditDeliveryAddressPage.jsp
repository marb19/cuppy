...
<%@ taglib prefix="address" tagdir="/WEB-INF/tags/addons/chineseprofileaddon/responsive/address" %>
...
<%@ taglib prefix="multi-checkout" tagdir="/WEB-INF/tags/addons/chineseprofileaddon/responsive/checkout/multi"%>
											...
											<c:forEach items="${deliveryAddresses}" var="address" varStatus="status">
												<div class="addressEntry">
													<form action="${request.contextPath}/checkout/multi/delivery-address/select" method="GET">
														...
														<%@ include file="/WEB-INF/views/addons/chineseprofileaddon/responsive/fragments/address/addressBookEntry.jsp" %>
