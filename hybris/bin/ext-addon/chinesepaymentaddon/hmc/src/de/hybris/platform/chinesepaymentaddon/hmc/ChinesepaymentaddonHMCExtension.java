 ...
 *
 */
package de.hybris.platform.chinesepaymentaddon.hmc;
...
/**
 * Provides necessary meta information about the chinesepaymentaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.7.0.0-SNAPSHOT
 */
public class ChinesepaymentaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(ChinesepaymentaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.chinesepaymentaddon.hmc.locales";
