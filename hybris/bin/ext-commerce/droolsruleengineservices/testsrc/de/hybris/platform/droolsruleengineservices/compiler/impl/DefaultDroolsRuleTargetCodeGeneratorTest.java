...
public class DefaultDroolsRuleTargetCodeGeneratorTest
{
	...
	public void setUp()
	{
		...
		given(engineRuleDao.getRuleByCode(RULE_CODE)).willReturn(droolsRule);
		...
		droolsRuleTargetCodeGenerator.setEngineRuleDao(engineRuleDao);
	...
	public void validRuleIrTest() throws RuleCompilerException
	{
		...
		given(
				droolsRuleConditionsGenerator.generateConditions(new DefaultDroolsGeneratorContext(compilerContext, ruleIr),
	...
	public void validCreateNewRule() throws RuleCompilerException
	{
		...
		ruleIr.setConditions(Collections.singletonList(condition));
		ruleIr.setActions(Collections.singletonList(action));
		given(engineRuleDao.getRuleByCode(RULE_CODE)).willThrow(ModelNotFoundException.class);
