...
public class DefaultB2BUnitFacadeIntegrationTest extends AbstractCommerceOrgIntegrationTest
{
	...
	{
		final SearchPageData<UserData> searchPageData = b2bUnitFacade.getPagedCustomersForUnit(DEFAULT_PAGEABLE_DATA,
				"DC Sales Detroit");
	...
	public void testGetPagedAdministratorsForUnit()
	{
		...
		final SearchPageData<UserData> searchPageData = b2bUnitFacade.getPagedAdministratorsForUnit(DEFAULT_PAGEABLE_DATA, "DC");
	...
	public void testGetPagedManagersForUnit()
	{
		...
		final SearchPageData<UserData> searchPageData = b2bUnitFacade.getPagedManagersForUnit(DEFAULT_PAGEABLE_DATA, "DC");
	...
	{
		SearchPageData<UserData> pageData = b2bUnitFacade.getPagedUserDataForUnit(DEFAULT_PAGEABLE_DATA, "DC");
