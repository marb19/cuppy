...
public class DefaultB2BUserGroupFacadeIntegrationTest extends AbstractCommerceOrgIntegrationTest
{
	...
	{
		final SearchPageData<UserData> searchPageData = defaultB2BUserGroupFacade.getPagedCustomersForUserGroup(
	...
	{
		final SearchPageData<UserData> searchPageData = defaultB2BUserGroupFacade.getPagedUserData(PAGEABLE_DATA_0_5_BY_NAME);
		assertSearchPageData(5, searchPageData);
		assertNotNull("Search page data pagination is null.", searchPageData.getPagination());
	...
	public void testAddMemberToUserGroup()
	{
		...
		final UserData user = defaultB2BUserGroupFacade.addMemberToUserGroup("EUROPE_MANAGER_PERM_GROUP_DC", "DC S HH");
	...
	public void testRemoveMemberFromUserGroup()
	{
		...
		final UserData user = defaultB2BUserGroupFacade.removeMemberFromUserGroup("EUROPE_MANAGER_PERM_GROUP_DC",
				"DC Sales DE Boss");
		assertNotNull("User is null.", user);
