...
public class DefaultATPServiceTest extends WarehousingBaseIntegrationTest
{
	...
	private final static Long THRESHOLD = Long.valueOf(5L);
	...
	public void setUp() throws Exception
	{
		...
		orderEntry.setQuantity(Long.valueOf(10L));
		...
		consignmentEntry1.setQuantity(Long.valueOf(6L));
		...
		consignmentEntry2.setQuantity(Long.valueOf(4L));
		...
		createNewAllocationEvt(warehouse5, product, Long.valueOf(1L));
		createNewAllocationEvt(warehouse4, product, Long.valueOf(7L));
		createNewCancellationEvt(warehouse4, product, Long.valueOf(7L));
	}
	...
	public void shouldGetATPForBaseStore()
	{
		...
		// Then
		assertThat(globalATP, is(Long.valueOf(576L)));
	}
	...
	public void shouldGetATPForBaseStoreWithThreshold()
	{
		...
		// Then
		assertThat(globalATP, is(Long.valueOf(571L)));
	}
	...
	public void shouldGetDifferentATPForBaseStore_NewAllocationEvent()
	{
		...
		createNewAllocationEvt(warehouse, product, Long.valueOf(576L));

		// When
		final Long globalATP = commerceStockService.getStockLevelForProductAndBaseStore(product, baseStore);

		// Then
		assertThat(globalATP, is(Long.valueOf(0L)));
	}
	...
	public void shouldGetDifferentATPForBaseStore_NewCancellationEvent()
	{
		...
		createNewCancellationEvt(warehouse, product, Long.valueOf(576L));

		// When
		final Long globalATP = commerceStockService.getStockLevelForProductAndBaseStore(product, baseStore);

		// Then
		assertThat(globalATP, is(Long.valueOf(1152L)));
	}
	...
	public void shouldGetNegativeATPForBaseStore_NewAllocationEvent()
	{
		...
		final BaseStoreModel baseStore = baseStoreService.getBaseStoreForUid(BASESTORE_NAME);
		final WarehouseModel warehouse = warehouseService.getWarehouseForCode(WAREHOUSE_1);
		createNewAllocationEvt(warehouse, product, Long.valueOf(676L));

		// When
		final Long globalATP = commerceStockService.getStockLevelForProductAndBaseStore(product, baseStore);

		// Then
		assertThat(globalATP, is(Long.valueOf(-100L)));
	}
	...
	public void shouldGetDifferentATPForBaseStore_MultipleNewAllocationEvent()
	{
		...
		createNewAllocationEvt(warehouse, product, Long.valueOf(176L));
		createNewAllocationEvt(warehouse, product, Long.valueOf(200L));

		// When
		final Long globalATP = commerceStockService.getStockLevelForProductAndBaseStore(product, baseStore);

		// Then
		assertThat(globalATP, is(Long.valueOf(200L)));
	}
	...
	public void shouldGetATPForPOS()
	{
		...
		// Then
		assertThat(localATP, is(Long.valueOf(2L)));
	}
	...
	public void shouldGetDifferentATPForPOS_NewAllocationEvent()
	{
		...
		final PointOfServiceModel pos = pointOfServiceService.getPointOfServiceForName(POS_NAME);
		final WarehouseModel warehouse = warehouseService.getWarehouseForCode(WAREHOUSE_1);
		createNewAllocationEvt(warehouse, product, Long.valueOf(2L));

		// When
		final Long localATP = commerceStockService.getStockLevelForProductAndPointOfService(product, pos);

		// Then
		assertThat(localATP, is(Long.valueOf(0L)));
	}
	...
	public void shouldGetDifferentATPForPOS_MultipleNewAllocationEvent()
	{
		...
		final PointOfServiceModel pos = pointOfServiceService.getPointOfServiceForName(POS_NAME);
		final WarehouseModel warehouse = warehouseService.getWarehouseForCode(WAREHOUSE_1);
		createNewAllocationEvt(warehouse, product, Long.valueOf(1L));
		createNewAllocationEvt(warehouse, product, Long.valueOf(1L));
	...
	public void shouldGetNegativeATPForPOS_NewAllocationEvent()
	{
		...
		final PointOfServiceModel pos = pointOfServiceService.getPointOfServiceForName(POS_NAME);
		final WarehouseModel warehouse = warehouseService.getWarehouseForCode(WAREHOUSE_1);
		createNewAllocationEvt(warehouse, product, Long.valueOf(3L));

		// When
		final Long localATP = commerceStockService.getStockLevelForProductAndPointOfService(product, pos);

		// Then
		assertThat(localATP, is(Long.valueOf(-1L)));
	}
	...
	private void createNewAllocationEvt(final WarehouseModel warehouse, final ProductModel product, final Long allocationQuantity)
	{
		...
		newAllocationEvt.setQuantity(allocationQuantity.longValue());
			...
			final Long cancellationQuantity)
	{
		...
		newCancellationEvt.setReason("My Reason");
		newCancellationEvt.setQuantity(cancellationQuantity.longValue());
