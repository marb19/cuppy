...
public class DefaultRuleConditionsConverterTest
{
	...
	protected List<RuleConditionData> createRuleConditionsSimple()
	{
		...
		when(ruleConditionsRegistry.getAllConditionDefinitionsAsMap())
				.thenReturn(Collections.singletonMap("condition", ruleConditionDefinition));
	...
	protected boolean isSameConditions(final List<RuleConditionData> ruleConditions1,
			final List<RuleConditionData> ruleConditions2)
	{
