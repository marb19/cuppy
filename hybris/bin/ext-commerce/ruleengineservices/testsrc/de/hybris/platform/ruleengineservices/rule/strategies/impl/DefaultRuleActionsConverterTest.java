...
public class DefaultRuleActionsConverterTest
{
	...
	protected List<RuleActionData> createRuleActionsSimple()
	{
		...
		when(ruleActionsRegistry.getAllActionDefinitionsAsMap())
				.thenReturn(Collections.singletonMap("action", ruleActionDefinition));
	...
	public void convertToStringEmpty() throws Exception
	{
		...
		// when
		final String value = ruleActionsConverter.toString(actions);
	...
	public void convertToStringSimple() throws Exception
	{
		...
		// when
		final String value = ruleActionsConverter.toString(ruleActions);
