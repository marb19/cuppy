...
public class DefaultRuleActionsTranslatorTest
{
	...
	public void setUp()
	{
		...
		ruleActionsTranslator.setRuleActionsRegistry(ruleActionsRegistry);
	...
	public void translateActions() throws Exception
	{
		...
		when(ruleActionsRegistry.getAllActionDefinitionsAsMap())
				.thenReturn(Collections.singletonMap(ACTION_DEFINITION_ID, ruleActionDefinition));
	...
	public void actionTranslatorNotFound() throws Exception
	{
		...
		when(ruleActionsRegistry.getAllActionDefinitionsAsMap())
				.thenReturn(Collections.singletonMap(ACTION_DEFINITION_ID, ruleActionDefinition));
		when(applicationContext.getBean(ACTION_TRANSLATOR_ID, RuleActionTranslator.class))
				.thenThrow(new NoSuchBeanDefinitionException(ACTION_TRANSLATOR_ID));
