...
import de.hybris.platform.sap.productconfig.model.dataloader.configuration.DataLoaderFactory;
...
/**
 * This action is deprecated, on the HMC UI it has been removed. In case you want to provide data loader functions to
 * HMC, use a new SSC UI. See de.hybris.platform.sap.sapproductconfigbackoffice.actions.DataloaderInitialLoadItemAction
 * as a reference
 */
@Deprecated
public class DataloaderInitialLoadItemAction extends ItemAction
{
	...
	private final DataLoaderFactory factory = new DataLoaderFactory();
	...
	protected IDataloaderSource getSAPSource(final SAPConfiguration configuration)
	{
		...
		dataloaderSource = factory.createDataLoaderSource(params);
