...
public class ConfigurationContextAndPricingWrapperImpl implements ConfigurationContextAndPricingWrapper
{
			...
			throws InteractivePricingException
	{
		if (pricingConfigurationParameter != null && pricingConfigurationParameter.isPricingSupported())
		{
			...
			logPricingConditions(pricingItem);
		}
	}
	...
	private void logPricingConditions(final IPricingItem pricingItem)
	{
		if (LOG.isDebugEnabled())
		{
	...
	private void logPricingConfigurationParameters()
	{
		if (LOG.isDebugEnabled())
		{
			if (pricingConfigurationParameter != null && LOG.isDebugEnabled())
			{
			...
			if (configurationParameterB2B != null && LOG.isDebugEnabled())
			{
