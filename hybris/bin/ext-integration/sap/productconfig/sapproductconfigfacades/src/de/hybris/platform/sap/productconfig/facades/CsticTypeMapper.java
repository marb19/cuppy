...
import de.hybris.platform.sap.productconfig.facades.impl.HybrisCsticAndValueNames;
...
public interface CsticTypeMapper
{
	 ...
	 * @return target - characteristic DTO
	 */
	public CsticData mapCsticModelToData(CsticModel model, String groupName, Map<String, HybrisCsticAndValueNames> nameMap);
