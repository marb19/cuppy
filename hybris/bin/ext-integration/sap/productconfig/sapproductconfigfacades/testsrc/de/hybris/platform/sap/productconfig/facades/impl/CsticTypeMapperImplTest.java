...
public class CsticTypeMapperImplTest
{
	...
	public void testDeltaPrice_noPrice()
	{
		...
		final CsticValueData valueDTO = typeMapper.createDomainValue(model, value, HybrisCsticAndValueNames.NULL_OBJ, "", false);
	...
	public void testInstanceId()
	{
		...
		final CsticData csticData = typeMapper.mapCsticModelToData(model, "P", new HashMap<String, HybrisCsticAndValueNames>());
	...
	public void testMapCsticModelToData_ValueDescriptionInHybris()
	{
		...
		given(attributeValue.getCode()).willReturn(CHBOX_VALUE_NAME);
