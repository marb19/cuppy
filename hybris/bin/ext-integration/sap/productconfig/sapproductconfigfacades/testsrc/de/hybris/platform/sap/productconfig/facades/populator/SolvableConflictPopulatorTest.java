...
public class SolvableConflictPopulatorTest
{
	...
	{
		assertNull(classUnderTest.findCsticsInConfiguration(configurationDataNoGroups, conflictingAssumption));
	}
	...
	public void testFindCsticInConfigurationNoCstics()
	{
		...
		assertNull("Group w/o cstics: We expect no result",
				classUnderTest.findCsticsInConfiguration(configurationData, conflictingAssumption));
	}
	...
	public void testFindCsticInConfigurationEmptyCstics()
	{
		...
		assertNull("Group with empty cstics list: We expect no result",
				classUnderTest.findCsticsInConfiguration(configurationData, conflictingAssumption));
	}
	...
	public void testCreateConflictUiGroup()
	{
		...
		assertEquals("We expect that the status of the conflict to be 'Conflict Status'", CsticStatusType.CONFLICT, csticsAtUiGroup
				.get(0).getCsticStatus());
	}
