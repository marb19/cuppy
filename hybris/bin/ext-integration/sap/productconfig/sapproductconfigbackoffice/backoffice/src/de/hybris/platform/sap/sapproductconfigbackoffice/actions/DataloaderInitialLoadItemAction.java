...
public class DataloaderInitialLoadItemAction implements CockpitAction<SAPConfigurationModel, String>
{
	...
	public ActionResult<String> perform(final ActionContext<SAPConfigurationModel> ctx)
	{
		...
		if (configuration == null || configuration.getSapproductconfig_sapServer() == null
				|| configuration.getSapproductconfig_sapServer().getRfcDestinationName() == null
				|| configuration.getSapproductconfig_sapServer().getRfcDestinationName().isEmpty()
		...
		if (isDataLoadRunning(ctx))
		{
			final boolean stopJobResult = stopDataload(ctx);
	...
	protected boolean stopDataload(final ActionContext<SAPConfigurationModel> ctx)
	{
	...
	protected boolean isDataLoadRunning(final ActionContext<SAPConfigurationModel> ctx)
	{
