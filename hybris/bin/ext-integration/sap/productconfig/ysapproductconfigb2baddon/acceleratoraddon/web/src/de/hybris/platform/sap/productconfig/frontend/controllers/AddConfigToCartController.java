...
{
	private static final Logger LOG = Logger.getLogger(AddConfigToCartController.class.getName());
	...
	final String productCode, @ModelAttribute(Sapproductconfigb2baddonConstants.CONFIG_ATTRIBUTE)
	@Valid
	...
	final ConfigurationData configData, final BindingResult bindingResult, final Model model,
			final RedirectAttributes redirectAttributes) throws CMSItemNotFoundException, UnsupportedEncodingException
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("AddConfigToCart POST for '" + productCode + "'");
		}
	...
	final String productCode, final String url) throws CMSItemNotFoundException, UnsupportedEncodingException
	{
		if (LOG.isDebugEnabled())
		{
