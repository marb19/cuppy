...
public class CSSClassResolverFactory
{
	...
	private static CSSClassResolver getCSSClassResolver()
	{
		if (resolver == null)
		{
			...
			{
				resolver = (CSSClassResolver) Registry.getApplicationContext()
						.getBean("sapProductConfigDefaultCssClassResponsiveResolver");
			}
			else
			{
	...
	{
		return getCSSClassResolver().getGroupStyleClass(group, false);
	}
