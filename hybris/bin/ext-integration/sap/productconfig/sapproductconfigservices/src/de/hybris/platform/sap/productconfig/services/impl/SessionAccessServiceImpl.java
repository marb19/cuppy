...
public class SessionAccessServiceImpl implements SessionAccessService
{
	...
	public String getConfigIdForCartEntry(final String cartEntryKey)
	{
		...
		final Map<String, String> sessionConfigCartEntryCache = (Map<String, String>) getSessionService().getAttribute(
				SESSION_STORAGE_CART_ENTRY_CONFIGURATIONS);
	...
	public String getCartEntryForConfigId(final String configId)
	{
		...
		final Map<String, Object> sessionUiStatusCache = (Map<String, Object>) getSessionService().getAttribute(
				SESSION_STORAGE_CART_ENTRY_CONFIGURATIONS);
		if (sessionUiStatusCache != null)
		{
	...
	{
		String cartEntryKey = null;
		final Map<String, String> sessionProductCartEntryCache = (Map<String, String>) getSessionService().getAttribute(
				SESSION_STORAGE_PRODUCT_CART_ENTRIES);
