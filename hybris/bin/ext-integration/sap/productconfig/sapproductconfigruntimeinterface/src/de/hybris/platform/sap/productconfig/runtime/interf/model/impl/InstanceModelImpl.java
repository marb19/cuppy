...
public class InstanceModelImpl extends BaseModelImpl implements InstanceModel
{
	...
	private List<InstanceModel> subInstances = Collections.EMPTY_LIST;
	private List<CsticModel> cstics = Collections.EMPTY_LIST;

	private Map<String, CsticModel> cachedCstics = null;

	private List<CsticGroupModel> csticGroups = Collections.EMPTY_LIST;
	...
	{
		if (this.subInstances == Collections.EMPTY_LIST)
		{
	...
	public CsticModel getCstic(final String csticName)
	{
		...
		final CsticModel cstic = cachedCstics.get(csticName);
		return cstic;
	}
	...
	{
		if (this.cstics == Collections.EMPTY_LIST)
		{
	...
	{
		if (this.csticGroups == Collections.EMPTY_LIST)
		{
