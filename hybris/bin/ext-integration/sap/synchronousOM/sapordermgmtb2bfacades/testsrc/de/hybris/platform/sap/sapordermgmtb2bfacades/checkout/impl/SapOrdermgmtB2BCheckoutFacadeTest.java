...
public class SapOrdermgmtB2BCheckoutFacadeTest
{
	...
	/**
	 * Test method for
	 * {@link de.hybris.platform.sap.sapordermgmtb2bfacades.checkout.impl.SapOrdermgmtB2BCheckoutFacade#createCartFromOrder(java.lang.String)}
	 * .
	 */
	@Test(expected = ApplicationBaseRuntimeException.class)
	public void testCreateCartFromOrder()
	{
		sapOrdermgmtB2BCheckoutFacade.createCartFromOrder("orderCode");
	}
