 ...
 *
 */
package de.hybris.platform.sap.sapinvoiceaddon.setup;
 ...
 */
@SystemSetup(extension = SapinvoiceaddonConstants.EXTENSIONNAME)
public class InitialDataSystemSetup extends AbstractSystemSetup
{
			...
			final List<String> contentCatalogs)
	{
		...
		importImpexFile(context, "/sapinvoiceaddon/import/contentCatalogs/" + catalogName + "ContentCatalog/cms-content.impex",
				true);
