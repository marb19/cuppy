...
import com.hybris.datahub.core.services.impl.DefaultFragmentReader;
...
public class DefaultItemImportFacadeIntegrationTest extends ServicelayerTest
{
	...
	public void setUp()
	{
		...
		final DataHubImpExResourceFactory resourceFactory = new DataHubImpExResourceFactory();
		final DefaultFragmentReader fragmentReader = new DefaultFragmentReader();
		fragmentReader.setDataHubFacade(mockDataHubFacade());
		resourceFactory.setFragmentReader(fragmentReader);
