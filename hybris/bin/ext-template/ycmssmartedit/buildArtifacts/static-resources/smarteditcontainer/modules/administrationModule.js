 ...
 *
 * The administartion module provides services to display and manage configurations
 ...
 *
 * @description
 * Service that provides convenient methods to manage configurations within the editor.
 *
 */
.factory('ConfigurationEditor', ['$resource', 'hitch', 'copy', '$q', 'convertToArray', '$log', 'loadConfigManagerService', 'ParseError', 'CONFIGURATION_URI', function($resource, hitch, copy, $q, convertToArray, $log, loadConfigManagerService, ParseError, CONFIGURATION_URI) {
        ...
        /**
         * @ngdoc method
         * @name administration.ConfigurationEditor#reset
         * @methodOf administration.ConfigurationEditor
         *
         * @description
         * Method called when "Reset" button is clicked in the configuration editor.
         * This method sets the form to pristine state.
         *
         ...
         */
        ConfigurationEditor.prototype.reset = function(configurationForm) {
         ...
         *
         * @description
         * Method used to add a new entry to the list of configurations.
         *
         */
         ...
         *
         * @description
         * Method used to delete a select entry from the list of configurations.
         * This method does not delete the configuration but it just removes it from the configurations array.
         * It will be only deleted when a user clicks the "submit" button.
         *
         * @param {Object} entry The object that needs to be deleted
         * @param {Object} configurationForm The form object which is an instance of {@link https://docs.angularjs.org/api/ng/type/form.FormController FormController}
         * that provides methods to monitor and control the state of the form.
         */
         ...
         *
         * @description
         * Method called when "Submit" button is clicked in the configuration editor.
         * Method used to save the list of available configurations by making a REST call to a web service.
         *
         * @param {Object} configurationForm The form object which is an instance of {@link https://docs.angularjs.org/api/ng/type/form.FormController FormController}
         * that provides methods to monitor and control the state of the form.
         */
         ...
         *
         * @description
         * Method that initializes the configuration editor and loads all the configurations for editing purposes.
         *
         * @param {Function} loadCallback A callback to be executed on loading the configurations.
         */
 ...
 *
 * @description
 * HTML marker that attaches functions of {@link administration.ConfigurationEditor ConfigurationEditor}
 * to the DOM elements of <b>generalConfigurationTemplate</b> for displaying the configuration editor.
 *
 */
