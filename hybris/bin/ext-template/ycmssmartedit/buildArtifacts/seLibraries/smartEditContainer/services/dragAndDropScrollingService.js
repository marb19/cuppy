    ...
    angular.module('dragAndDropScrollingModule', [])
        ...
        .factory('dragAndDropScrollingService', function($filter, hitch) {
            ...
            var _addUIHints = function() {
                ...
                if (SM_UI && SM_UI._getBrowser() === SM_UI._BROWSERS.FIREFOX) {
            ...
            var _registerScrollingInPage = function() {
                ...
                iFrameBody.bind('mousemove', function(event) {
                    ...
                    if (SM_UI._getBrowser() === SM_UI._BROWSERS.FIREFOX && areHintsVisible && !dragStartedInExternalFrame) {
            ...
            var _showUIHints = function(isExternalFrame) {
                ...
                if (!isExternalFrame && SM_UI._getBrowser() === SM_UI._BROWSERS.FIREFOX) {
