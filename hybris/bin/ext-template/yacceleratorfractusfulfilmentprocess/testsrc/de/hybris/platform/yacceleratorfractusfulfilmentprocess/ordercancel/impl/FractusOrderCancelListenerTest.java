...
import de.hybris.platform.yacceleratorfractusfulfilmentprocess.ordercancel.impl.FractusOrderCancelEvent;
import de.hybris.platform.yacceleratorfractusfulfilmentprocess.ordercancel.impl.FractusOrderCancelListener;
...
public class FractusOrderCancelListenerTest
{
	...
	@Test
	public void testOnEventShouldSyncOrderStatus() throws UnknownEcpStatusException, NoMatchingYaasStatusException
	{
	...
	@Test
	public void testOnEventShouldNotSyncOrderStatus() throws UnknownEcpStatusException, NoMatchingYaasStatusException
	{
		FractusOrderCancelEvent event = new FractusOrderCancelEvent();
		event.setOrderModel(orderModel);
		event.setOrderCancelRecordEntryModel(orderCancelRecordEntryModel);
	...
	@Test
	public void testOnEventShouldNotSyncOrderStatusWithUnknownEcpStatus()
			throws UnknownEcpStatusException, NoMatchingYaasStatusException
	{
		FractusOrderCancelEvent event = new FractusOrderCancelEvent();
		event.setOrderModel(orderModel);
		event.setOrderCancelRecordEntryModel(orderCancelRecordEntryModel);
	...
	@Test
	public void testOnEventShouldNotSyncOrderStatusWithNoMatchingYaasStatus()
			throws UnknownEcpStatusException, NoMatchingYaasStatusException
	{
		FractusOrderCancelEvent event = new FractusOrderCancelEvent();
		event.setOrderModel(orderModel);
