...
public class FractusCommercePlaceOrderStrategy implements CommercePlaceOrderStrategy
{
	...
	/**
	 * The fractus order is created from datahub import, so there is no cart exists.
	 * The fractus order status initial is CREATED.
	 */
	protected boolean isFractusOrder(CommerceCheckoutParameter parameter)
	{
	...
	@Required
	public void setOrderService(FractusOrderService orderService)
	{
