...
module.exports = function(config) {
    config.set({
        ...
        junitReporter: {
            outputDir: 'jsTarget/test/ysmarteditmoduleInner/junit/', // results will be saved as $outputDir/$browserName.xml
        ...
        files: [
            ...
            'jsTarget/web/features/ysmarteditmoduleInner/templates.js',
            'web/features/ysmarteditmoduleInner/**/*.js',
            'jsTests/ysmarteditmoduleInner/unit/features/**/*.js'
        ],
