...
module.exports = function(config) {
    config.set({
        ...
        junitReporter: {
            outputDir: 'jsTarget/test/ysmarteditmoduleOuter/junit/', // results will be saved as $outputDir/$browserName.xml
        ...
        files: [
            ...
            'jsTarget/web/features/ysmarteditmoduleOuter/templates.js',
            'web/features/ysmarteditmoduleOuter/**/*.js',
            'jsTests/ysmarteditmoduleOuter/unit/features/**/*.js'
        ],
