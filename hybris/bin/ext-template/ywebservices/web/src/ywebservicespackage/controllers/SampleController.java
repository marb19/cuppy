...
public class SampleController
{
	...
	/**
	 * Sample method returning Cache-Control header and using Path Variable</br> Example :</br> GET
	 * http://localhost:9001/ywebservices/sample/dto/sampleValue
	 *
	 * @param pathVariable
	 ...
	 * Example :</br> URL : http://localhost:9001/ywebservices/sample/dto</br> Method : POST</br> Header :
	 * Content-Type=application/json</br> POST body parameter :{ "value" : "sampleValue"}</br>
	 *
	 * @param sampleWsDTO
