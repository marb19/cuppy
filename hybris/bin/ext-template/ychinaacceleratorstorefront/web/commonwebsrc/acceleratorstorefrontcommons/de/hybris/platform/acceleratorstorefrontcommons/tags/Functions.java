...
public class Functions
{
	...
	public static boolean doesPromotionExistForOrderEntry(final List<PromotionResultData> productPromotions,
			final int entryNumber)
	{
		if (productPromotions != null && !productPromotions.isEmpty())
		{
			...
			for (final PromotionResultData productPromotion : productPromotions)
			{
				...
				{
					return doesPromotionExistForOrderEntry(entryNumberToFind, productPromotion);
				}
			}
		}
		return false;
