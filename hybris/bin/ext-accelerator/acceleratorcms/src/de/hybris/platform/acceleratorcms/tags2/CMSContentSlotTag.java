...
public class CMSContentSlotTag extends BodyTagSupport implements DynamicAttributes
{
	...
	protected Map<String, String> getElementAttributes()
	{
		...
		{
			mergedAttributes.putAll(dynamicAttributes);
		}
		if (currentCmsPageRequestContextData.isLiveEdit())
		{
			mergedAttributes = htmlElementHelper
					.mergeAttributeMaps(mergedAttributes, elementCssClassMap, createLiveEditAttributes());
		}
