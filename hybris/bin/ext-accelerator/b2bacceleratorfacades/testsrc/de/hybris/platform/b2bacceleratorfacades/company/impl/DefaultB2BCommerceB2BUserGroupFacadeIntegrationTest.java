...
import static de.hybris.platform.b2bcommercefacades.util.B2BCommercefacadesTestUtils.getSelectedPermissions;
...
import static de.hybris.platform.b2bcommercefacades.util.B2BCommercefacadesTestUtils.isPermissionIncluded;
...
public class DefaultB2BCommerceB2BUserGroupFacadeIntegrationTest extends AbstractCommerceOrgIntegrationTest
{
	...
	{
		final SearchPageData<UserData> searchPageData = legacyB2BCommerceB2BUserGroupFacade
				.getPagedCustomersForUserGroup(PAGEABLE_DATA_0_5_BY_NAME, "DC");
		...
		final List<UserData> selectedUsers = getSelectedUsers(searchPageData.getResults());
	...
	{
		SearchPageData<B2BPermissionData> searchPageData = legacyB2BCommerceB2BUserGroupFacade
				.getPagedPermissionsForUserGroup(PAGEABLE_DATA_0_20_BY_NAME, "EUROPE_MANAGER_PERM_GROUP_DC");
		assertSearchPageData(19, searchPageData);
		assertNotNull("Search page data pagination is null.", searchPageData.getPagination());
		assertEquals("Unexpected total number of results.", 19, searchPageData.getPagination().getTotalNumberOfResults());
	...
	public void testAddMemberToUserGroup()
	{
		...
		final UserData user = legacyB2BCommerceB2BUserGroupFacade.addMemberToUserGroup("EUROPE_MANAGER_PERM_GROUP_DC", "DC S HH");
	...
	public void testRemoveMemberFromUserGroup()
	{
		...
		final UserData user = legacyB2BCommerceB2BUserGroupFacade.removeMemberFromUserGroup("EUROPE_MANAGER_PERM_GROUP_DC",
				"DC Sales DE Boss");
		assertNotNull("User is null.", user);
