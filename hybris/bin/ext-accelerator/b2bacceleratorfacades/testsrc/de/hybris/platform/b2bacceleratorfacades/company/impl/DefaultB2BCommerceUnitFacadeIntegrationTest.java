...
public class DefaultB2BCommerceUnitFacadeIntegrationTest extends AbstractCommerceOrgIntegrationTest
{
	...
	{
		final SearchPageData<UserData> searchPageData = legacyB2BCommerceUnitFacade.getPagedApproversForUnit(DEFAULT_PAGEABLE_DATA,
				"DC Sales US");
		...
		final UserData user1 = searchPageData.getResults().get(0);
		...
		final UserData user2 = searchPageData.getResults().get(1);
		...
		final UserData user3 = searchPageData.getResults().get(2);
		...
		final UserData user4 = searchPageData.getResults().get(3);
	...
	{
		final SearchPageData<UserData> searchPageData = legacyB2BCommerceUnitFacade.getPagedCustomersForUnit(DEFAULT_PAGEABLE_DATA,
				"DC Sales Detroit");
	...
	public void testGetPagedAdministratorsForUnit()
	{
		...
		final SearchPageData<UserData> searchPageData = legacyB2BCommerceUnitFacade.getPagedAdministratorsForUnit(
	...
	public void testGetPagedManagersForUnit()
	{
		...
		final SearchPageData<UserData> searchPageData = legacyB2BCommerceUnitFacade.getPagedManagersForUnit(DEFAULT_PAGEABLE_DATA,
				"DC");
	...
	public void testAddApproverToUnit()
	{
		...
		for (final UserData user : searchPageData.getResults())
		{
	...
	public void testRemoveApproverFromUnit()
	{
		...
		SearchPageData<UserData> searchPageData = legacyB2BCommerceUnitFacade.getPagedApproversForUnit(DEFAULT_PAGEABLE_DATA,
				"DC Sales");
		assertSearchPageData(4, searchPageData);
		UserData user = searchPageData.getResults().get(0);
	...
	{
		SearchPageData<UserData> pageData = legacyB2BCommerceUnitFacade.getPagedUserDataForUnit(DEFAULT_PAGEABLE_DATA, "DC");
