...
public class DefaultB2BCommerceUserFacadeIntegrationTest extends AbstractCommerceOrgIntegrationTest
{
	...
	{
		final SearchPageData<UserData> searchPageData = legacyB2BCommerceUserFacade.getPagedApproversForCustomer(
	...
	public void shouldAddApproverForCustomer()
	{
		...
		SearchPageData<UserData> searchPageData = legacyB2BCommerceUserFacade.getPagedApproversForCustomer(
				PAGEABLE_DATA_0_20_BY_UNIT_NAME, DC_S_DET);
		assertSearchPageData(4, searchPageData);
	...
	public void shouldGetPagedPermissionsForCustomer()
	{
		...
		final List<B2BPermissionData> selectedPermissions = B2BCommercefacadesTestUtils.getSelectedPermissions(permissions
				.getResults());
	...
	public void shouldAddB2BUserGroupToCustomerAndRemoveB2BUserGroupFromCustomerGroups()
	{
		...
		assertSearchPageData(4, searchPageData);
		List<B2BUserGroupData> selectedB2BUserGroups = B2BCommercefacadesTestUtils
				.getSelectedUserGroups(searchPageData.getResults());
